                    ...
                    <tr key={itemId}>
                      ...
                      <td className='py-4 md:px-4 px-1'>
                        <div className='flex items-center md:gap-2 gap-1'>
                          ...
                          <input type="number" onChange={e => updateCartQuantity(product._id, Number(e.target.value))} value={cartItems[itemId]} className='w-8 border text-center appearance-none' />
